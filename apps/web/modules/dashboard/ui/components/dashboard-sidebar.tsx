...
import { InboxIcon, Layout, LibraryBigIcon } from "lucide-react";

import { Badge, CreditCardIcon , Import,   
        LayoutDashboardIcon ,
        Mic , PaletteIcon   } from "lucide-react";
                        ...
                        <OrganizationSwitcher 
                         ...
                         appearance={{
                            elements: {
                                ...
                                organizationSwitcherTrigger: "w-full! justify-start! group-data-[collapsible=icon]:size-8! group-dataa-[collapsible=icon]:p-2!",
                        ...
                        {customerSupportItems.map((item) => (
                            <SidebarMenuItem key={item.title} >
                                <SidebarMenuButton
                                    ...
                                    className={cn(
                                        isActive(item.url) && "bg-gradient-to-b from-sidebar-primary to-[#0b62f3]! text-sidebar-primary-foreground! hover:to-[#0b63f3]/90!",
                                    )}
                                    tooltip={item.title}
                                     >
                                        <Link href={item.url}>
