...
export const AIMessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:from-[#6D28D9] group-[.is-user]:to-[#6D28D9] group-[.is-user]:text-primary-foreground",
      className
    )}
    {...props}
  >
